    ...
    <Screen scrollable={false} className="justify-center bg-surface-bg dark:bg-neutral-950 px-4">
      ...
      >
        ...
        <View className="gap-1 mt-2">
          <Text className="text-[28px] font-bold text-ink dark:text-white tracking-tight leading-tight">Create account</Text>
          <Text className="text-sm text-muted-text">Receive crypto, get NGN in your bank.</Text>
        </View>
        ...
        <View className="gap-4 mt-2">
          ...
          <View className="flex-row gap-3">
            <Button
              ...
              onPress={() => Alert.alert('Sign up with Apple', 'This feature is coming soon.')}
              className="flex-1"
            />
            <Button
              label=""
              ...
              onPress={() => Alert.alert('Sign up with Google', 'This feature is coming soon.')}
              className="flex-1"
            />
          </View>
