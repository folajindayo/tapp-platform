    ...
    <Screen>
      ...
      <View className="gap-6">
        <View className="gap-2">
          <View className="h-14 w-14 rounded-2xl bg-brand-green/15 items-center justify-center mb-2">
            <Icon xml={Icons.IconBank} size={28} />
          </View>
          <Text className="text-sm text-muted-subtle uppercase tracking-wider">Step 4 of 4</Text>
          <Text className="text-3xl font-bold text-ink">Where should we send your money?</Text>
        </View>

        <View className="gap-2">
          <Text className="text-sm font-medium text-ink-700">Bank</Text>
          <Pressable
            className="h-14 rounded-lg px-4 flex-row items-center justify-between bg-surface-soft border border-line-muted"
