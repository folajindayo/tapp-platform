    ...
    <Screen scrollable={false}>
      ...
      <View className="flex-1 gap-6">
        <View className="gap-2">
          <Text className="text-sm text-muted-subtle uppercase tracking-wider">Step 3 of 4</Text>
          <Text className="text-3xl font-bold text-ink">Verify your identity</Text>
          <Text className="text-muted-text">
            We use your BVN to confirm your identity. Takes about 30 seconds.
          </Text>
        </View>
...
function BulletRow({ text }: { text: string }) {
  return (
    <View className="flex-row gap-3 items-start">
      <View className="h-1.5 w-1.5 rounded-full bg-brand-green mt-2.5" />
